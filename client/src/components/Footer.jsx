    ...
    <Footer container className='border border-t-8 border-teal-500'>
        <div className='w-full max-w-7xl mx-auto'>
            <div className='grid w-full justify-between sm:flex md: grid-cols-1'>
                ...
                <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-colos-3 sm:gap-6">
                    <div>
                    ...
                    <div>
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://www.github.com/rishavpaull'
                            target='_blank'
                            rel='noopener noreferrer'>
                                Github
                            </Footer.Link>
            ...
            <Footer.Copyright href='#' by="Rishav's blog" year={new Date().getFullYear()} />
